...
Squirrel.prototype.jump = function() {
    console.log(this.name + " goes jump, jump, jump!");
};
...
var slappy = new Squirrel("Slappy");
var skippy = new Squirrel("Skippy");

var squrilList = [fluffy, squeaky, slappy, skippy]

for (var i = 0, len = squrilList.length; i < len; i++) {
    squrilList[i].jump();
}